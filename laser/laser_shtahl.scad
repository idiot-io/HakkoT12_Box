...
module PCB(){
color("DarkKhaki") 
translate ([0,0,tapeHeight+1.6]) linear_extrude(height = 1.6, center = false, convexity = 10, twist = 0) import("bottom.dxf", convexity=3);
color("Gold") 
...
module top() {
    ...
    difference() {
        ...
        import(file = "top.dxf", layer = "0");
        //engraving
        color("white")
        translate([0.0, 0.0, height/2])
        linear_extrude(thickness)
        import(file = "top.dxf", layer = "engraving");
    }
}
...
module bottom() {
    ...
    difference() {
        ...
        import(file = "bottom.dxf", layer = "0");
    }
